...
let service: HelpQueueAuditService;
  ...
  describe('Queue Item Audit Logging', () => {
    it('should log queue item creation', () => {
      ...
      const entry = service.logQueueItemEvent(
        ...
        'ws-1',
        true,
        { title: 'Help with debugging', priority: 'high' }
      );
    ...
    it('should log queue item assignment', () => {
      ...
      const entry = service.logQueueItemEvent(
        ...
        'ws-1',
        true,
        { assignedTo: 'user-alice', assignmentTime: Date.now() }
      );
    ...
    it('should log queue item responses', () => {
      ...
      const entry = service.logQueueItemEvent(
        ...
        'ws-1',
        true,
        { responseLength: 250, responseTime: '2 hours' }
      );
    ...
    it('should log queue item resolution', () => {
      ...
      const entry = service.logQueueItemEvent(
        ...
        'ws-1',
        true,
        { resolvedBy: 'user-alice', resolutionTime: '4 hours' }
      );
  ...
  describe('Expert Audit Logging', () => {
    it('should log expert registration', () => {
      ...
      const entry = service.logExpertEvent(
        ...
        'ws-1',
        true,
        { expertise: ['debugging', 'performance'], availability: 'full-time' }
      );
    ...
    it('should log expert profile updates', () => {
      ...
      const entry = service.logExpertEvent(
        ...
        'ws-1',
        true,
        { previousExpertise: ['debugging'], newExpertise: ['debugging', 'performance'] }
      );
    ...
    it('should log expert availability changes', () => {
      ...
      const entry = service.logExpertEvent(
        ...
        'ws-1',
        true,
        { availabilityStatus: 'available', lastStatusChange: Date.now() }
      );
