...
describe('MergeResolverService', () => {
    ...
    describe('Merge Session Creation', () => {
        it('should create merge session', () => {
            ...
            const session = service.createMergeSession('user-1', 'user1@example.com', 'feature', 'main', 'base123', 'ours456', 'theirs789', diffs, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should emit merge-session-created event', () => {
            return new Promise((resolve) => {
                ...
                service.createMergeSession('user-2', 'user2@example.com', 'dev', 'main', 'base', 'ours', 'theirs', diffs, '192.168.1.1', 'Mozilla/5.0');
            });
        });
        it('should track multiple diffs in session', () => {
            ...
            const session = service.createMergeSession('user-3', 'user3@example.com', 'branch', 'main', 'base', 'ours', 'theirs', diffs, '192.168.1.1', 'Mozilla/5.0');
    ...
    describe('Conflict Resolution', () => {
        it('should resolve conflict with ours strategy', () => {
            ...
            const session = service.createMergeSession('user-4', 'user4@example.com', 'feature', 'main', 'base', 'ours', 'theirs', diffs, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should resolve conflict with theirs strategy', () => {
            ...
            const session = service.createMergeSession('user-5', 'user5@example.com', 'feature', 'main', 'base', 'ours', 'theirs', diffs, '192.168.1.1', 'Mozilla/5.0');
            const result = service.resolveConflict({
                userId: 'user-5',
        ...
        it('should resolve conflict with manual strategy', () => {
            ...
            const session = service.createMergeSession('user-6', 'user6@example.com', 'feature', 'main', 'base', 'ours', 'theirs', diffs, '192.168.1.1', 'Mozilla/5.0');
            const result = service.resolveConflict({
                userId: 'user-6',
        ...
        it('should emit conflict-resolved event', () => {
            return new Promise((resolve) => {
                ...
                const session = service.createMergeSession('user-7', 'user7@example.com', 'branch', 'main', 'base', 'ours', 'theirs', diffs, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should resolve multiple similar conflicts with autoResolve', () => {
            ...
            const session = service.createMergeSession('user-8', 'user8@example.com', 'feature', 'main', 'base', 'ours', 'theirs', diffs, '192.168.1.1', 'Mozilla/5.0');
            const result = service.resolveConflict({
                userId: 'user-8',
        ...
        it('should fail to resolve non-existent conflict', () => {
            ...
            const session = service.createMergeSession('user-9', 'user9@example.com', 'feature', 'main', 'base', 'ours', 'theirs', diffs, '192.168.1.1', 'Mozilla/5.0');
            const result = service.resolveConflict({
                userId: 'user-9',
    ...
    describe('Merge Completion', () => {
        it('should complete merge when all conflicts resolved', () => {
            ...
            const session = service.createMergeSession('user-10', 'user10@example.com', 'feature', 'main', 'base', 'ours', 'theirs', diffs, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should fail to complete merge with unresolved conflicts', () => {
            ...
            const session = service.createMergeSession('user-11', 'user11@example.com', 'feature', 'main', 'base', 'ours', 'theirs', diffs, '192.168.1.1', 'Mozilla/5.0');
            const result = service.completeMerge({
                userId: 'user-11',
        ...
        it('should emit merge-completed event', () => {
            return new Promise((resolve) => {
                ...
                const session = service.createMergeSession('user-12', 'user12@example.com', 'feature', 'main', 'base', 'ours', 'theirs', diffs, '192.168.1.1', 'Mozilla/5.0');
                service.resolveConflict({
                    userId: 'user-12',
    ...
    describe('Merge Abortion', () => {
        it('should abort merge', () => {
            ...
            const session = service.createMergeSession('user-13', 'user13@example.com', 'feature', 'main', 'base', 'ours', 'theirs', diffs, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should emit merge-aborted event', () => {
            return new Promise((resolve) => {
                ...
                const session = service.createMergeSession('user-14', 'user14@example.com', 'feature', 'main', 'base', 'ours', 'theirs', diffs, '192.168.1.1', 'Mozilla/5.0');
    ...
    describe('Diff Statistics', () => {
        it('should get diff statistics', () => {
            ...
            const session = service.createMergeSession('user-15', 'user15@example.com', 'feature', 'main', 'base', 'ours', 'theirs', diffs, '192.168.1.1', 'Mozilla/5.0');
    ...
    describe('Audit Logging', () => {
        it('should record audit entry on merge session create', () => {
            ...
            service.createMergeSession('user-16', 'user16@example.com', 'feature', 'main', 'base', 'ours', 'theirs', diffs, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should limit audit log size', () => {
            ...
            for (let i = 0; i < 10; i++) {
                ...
                service.createMergeSession('user-17', 'user17@example.com', 'feature', 'main', 'base', 'ours', 'theirs', diffs, '192.168.1.1', 'Mozilla/5.0');
            }
    ...
    describe('Statistics', () => {
        it('should get service statistics', () => {
            ...
            service.createMergeSession('user-18', 'user18@example.com', 'feature', 'main', 'base', 'ours', 'theirs', diffs, '192.168.1.1', 'Mozilla/5.0');
    ...
    describe('Shutdown', () => {
        it('should shutdown service', () => {
            ...
            const session = service.createMergeSession('user-21', 'user21@example.com', 'feature', 'main', 'base', 'ours', 'theirs', diffs, '192.168.1.1', 'Mozilla/5.0');
            service.shutdown();
...
//# sourceMappingURL=merge-resolver-service.test.js.map