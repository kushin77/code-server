...
exports.BlueGreenDeploymentManager = void 0;
class BlueGreenDeploymentManager {
    ...
    async prepareGreenEnvironment(version) {
    ...
    async validateNewEnvironment(env) {
        const errors = [];
        const warnings = [];
    ...
    async shiftTrafficToGreen(percentage) {
        const startTime = Date.now();
    ...
    async drainBlueEnvironment() {
        const startTime = Date.now();
        const maxDrainTime = 30000; // 30 seconds
        while (this.blueEnvironment.metrics.activeConnections > 0 &&
            (Date.now() - startTime) < maxDrainTime) {
            this.blueEnvironment.metrics.activeConnections = Math.max(0, this.blueEnvironment.metrics.activeConnections - 100);
    ...
    async compareEnvironments(blue, green) {
...
//# sourceMappingURL=BlueGreenDeploymentManager.js.map