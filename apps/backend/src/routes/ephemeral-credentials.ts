...
import { getEphemeralCredentialsService, VaultCredential } from "../services/ephemeral-credentials/vault-service.js"
 ...
 * }
 */
router.post("/verify-expiration", (req: Request, res: Response) => {
  try {
    const sessionId = req.session?.id
