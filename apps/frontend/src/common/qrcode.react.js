...
const QRCode = ({ value, size = 256, className = '' }) => {
    ...
    return (<canvas ref={canvasRef} width={size} height={size} className={className} style={{ border: '1px solid #ddd', borderRadius: '4px' }}/>);
};
export default QRCode;
//# sourceMappingURL=qrcode.react.js.map