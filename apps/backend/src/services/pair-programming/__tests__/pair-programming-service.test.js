...
describe('PairProgrammingService', () => {
    ...
    describe('Configuration', () => {
        it('should update configuration', () => {
            service.updateConfig({ maxSessionsPerWorkspace: 20 }, 'user-29', '192.168.1.1', 'Mozilla/5.0');
            expect(service).toBeDefined();
        });
        it('should emit config-updated event', () => {
            return new Promise((resolve) => {
                ...
                service.updateConfig({ maxParticipantsPerSession: 6 }, 'user-30', '192.168.1.1', 'Mozilla/5.0');
            });
        });
    });
    describe('Shutdown', () => {
...
//# sourceMappingURL=pair-programming-service.test.js.map