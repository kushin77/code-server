...
describe('PullRequestValidator', () => {
    ...
    describe('Error Handling', () => {
        it('should handle GitHub API errors gracefully', async () => {
            mockGitHub.getChangedFiles.mockRejectedValue(new Error('API rate limited'));
            expect(async () => {
                await validator.validatePullRequest({
                    pullNumber: 123,
                    owner: 'example',
        ...
        it('should provide detailed error context', async () => {
            mockGitHub.getChangedFiles.mockRejectedValue(new Error('Connection timeout'));
            try {
                await validator.validatePullRequest({
                    pullNumber: 123,
                    owner: 'example',
...
//# sourceMappingURL=PullRequestValidator.test.js.map