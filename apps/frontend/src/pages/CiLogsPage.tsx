      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm shadow-slate-100">
        ...
        <div className="mt-6 rounded-2xl border border-sky-200 bg-sky-50 px-4 py-4">
          ...
          <a
            ...
            className="mt-2 inline-flex items-center rounded-full border border-sky-300 bg-white px-4 py-2 text-sm font-medium text-sky-700 transition hover:border-sky-400 hover:text-sky-900"
          >
            Open GitHub Actions
          </a>
        </div>
