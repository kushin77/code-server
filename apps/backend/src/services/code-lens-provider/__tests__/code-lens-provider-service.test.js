...
describe('Code Lens Provider Service', () => {
    ...
    describe('Initialization', () => {
        it('should initialize service', () => {
            ...
            expect(service.lenses).toBeDefined();
    ...
    describe('Code Lens Updates', () => {
        it('should update code lens', () => {
            ...
            const result = service.updateCodeLens(created.lensId, { title: 'Updated References' }, 'user1', '192.168.1.1', 'Mozilla');
            expect(result.success).toBe(true);
        });
        it('should emit code-lens-updated event', () => {
            return new Promise((resolve) => {
                ...
                service.updateCodeLens(created.lensId, { title: 'Updated' }, 'user1', '192.168.1.1', 'Mozilla');
            });
        });
    });
    ...
    describe('Command Execution', () => {
        it('should execute command', () => {
            ...
            const result = service.executeCommand(created.lensId, 'goto.reference', [], 'user1', '192.168.1.1', 'Mozilla');
            expect(result.success).toBe(true);
    ...
    describe('Shutdown', () => {
        it('should shutdown service cleanly', () => {
            service.shutdown();
            expect(service.lenses.size).toBe(0);
            expect(service.references.size).toBe(0);
        });
    });
});
//# sourceMappingURL=code-lens-provider-service.test.js.map