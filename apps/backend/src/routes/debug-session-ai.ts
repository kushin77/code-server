...
router.post('/sessions', (req: Request, res: Response) => {
  try {
    ...
    logger.error('Failed to start debug session', error as Error);
    res.status(500).json({
      success: false,
...
router.get('/sessions/:sessionId', (req: Request, res: Response) => {
  try {
    ...
    logger.error('Failed to get debug session', error as Error);
    res.status(500).json({
      success: false,
 ...
 */
router.patch('/sessions/:sessionId/state', (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params;
 ...
 */
router.post('/sessions/:sessionId/breakpoints', (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params;
    ...
    logger.error('Failed to set breakpoint', error as Error);
    res.status(500).json({
      success: false,
 ...
 */
router.delete('/sessions/:sessionId/breakpoints/:breakpointId', (req: Request, res: Response) => {
  try {
    ...
    logger.error('Failed to remove breakpoint', error as Error);
    res.status(500).json({
      success: false,
 ...
 */
router.post('/sessions/:sessionId/variables', (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params;
    ...
    logger.error('Failed to capture variables', error as Error);
    res.status(500).json({
      success: false,
 ...
 */
router.post('/sessions/:sessionId/stack-frames', (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params;
    ...
    logger.error('Failed to capture stack frames', error as Error);
    res.status(500).json({
      success: false,
 ...
 */
router.post('/sessions/:sessionId/analyze', (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params;
    ...
    logger.error('Failed to analyze root cause', error as Error);
    res.status(500).json({
      success: false,
 ...
 */
router.post('/sessions/:sessionId/fix-suggestions', (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params;
    ...
    logger.error('Failed to generate fix suggestions', error as Error);
    res.status(500).json({
      success: false,
 ...
 */
router.get('/sessions/:sessionId/docs', (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params;
    ...
    logger.error('Failed to get relevant docs', error as Error);
    res.status(500).json({
      success: false,
...
router.delete('/sessions/:sessionId', (req: Request, res: Response) => {
  try {
    ...
    logger.error('Failed to delete debug session', error as Error);
    res.status(500).json({
      success: false,
