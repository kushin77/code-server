 ...
 */
export function initializeCRDTRoutes(
  router: express.Router,
  crdt: CRDTOperationsService,
): express.Router {
  /**
   ...
   */
  router.post('/documents/:documentId/insert', (req: Request, res: Response) => {
    try {
      const { documentId } = req.params;
   ...
   */
  router.post('/documents/:documentId/delete', (req: Request, res: Response) => {
    try {
      const { documentId } = req.params;
   ...
   */
  router.get('/documents/:documentId/history', (req: Request, res: Response) => {
    try {
      const { documentId } = req.params;
   ...
   */
  router.get('/documents/:documentId/sync', (req: Request, res: Response) => {
    try {
      const { documentId } = req.params;
 ...
 */
export function setupCRDTIntegration(app: Express): CRDTOperationsService {
 ...
 */
export async function createCRDTExampleApp(): Promise<Express> {
  const app = express();
