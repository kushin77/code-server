...
describe('CapacityForecastingService', () => {
    ...
    it('should dismiss breach alert', async () => {
        ...
        expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('UPDATE capacity_breach_alerts'), expect.any(Array));
    });
...
//# sourceMappingURL=capacity-forecasting.test.js.map