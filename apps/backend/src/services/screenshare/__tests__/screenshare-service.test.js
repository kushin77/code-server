...
describe('ScreenShareService', () => {
    ...
    describe('Configuration', () => {
        it('should update configuration', () => {
            service.updateConfig({ enableRecording: false }, 'user-33', '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should emit config-updated event', () => {
            return new Promise((resolve) => {
                ...
                service.updateConfig({ maxParticipantsPerSession: 50 }, 'user-34', '192.168.1.1', 'Mozilla/5.0');
            });
        });
    });
    describe('Shutdown', () => {
...
//# sourceMappingURL=screenshare-service.test.js.map