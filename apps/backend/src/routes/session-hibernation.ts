...
import SessionHibernationService, {
  HibernationState,
} from "../services/session/session-hibernation-service";
 ...
 */
router.post("/:sessionId/activity", (req: Request, res: Response) => {
  try {
 ...
 */
router.post("/:sessionId/checkpoint", (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params;
 ...
 * Hibernate a session
 */
router.post("/:sessionId/hibernate", (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params;
 ...
 */
router.post("/:sessionId/wake", (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params;
 ...
 */
router.get("/:sessionId/metrics", (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params;
 ...
 */
router.get("/:sessionId/checkpoint/:checkpointId", (req: Request, res: Response) => {
  try {
 ...
 */
router.post("/:sessionId/checkpoint/:checkpointId/restore", (req: Request, res: Response) => {
  try {
    const { sessionId, checkpointId } = req.params;
 ...
 * Delete a checkpoint
 */
router.delete("/:sessionId/checkpoint/:checkpointId", (req: Request, res: Response) => {
  try {
 ...
 */
router.get("/:sessionId/idle-duration", (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params;
 ...
 */
router.get("/config/idle", (req: Request, res: Response) => {
  try {
 ...
 */
router.patch("/config/idle", (req: Request, res: Response) => {
  try {
...
export const initializeSessionHibernationRoutes = (app: any) => {
