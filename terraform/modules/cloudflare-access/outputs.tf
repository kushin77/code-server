...
output "alertmanager_application_id" {
  ...
  value       = cloudflare_zero_trust_access_application.alertmanager.id
}

output "jaeger_application_id" {
  description = "Cloudflare Access application ID for Jaeger"
  value       = cloudflare_zero_trust_access_application.jaeger.id
}
...
output "ci_prometheus_service_token_client_id" {
  ...
  value       = cloudflare_zero_trust_access_service_token.ci_prometheus.client_id
  sensitive   = true
}
...
output "ci_prometheus_service_token_client_secret" {
  ...
  value       = cloudflare_zero_trust_access_service_token.ci_prometheus.client_secret
  sensitive   = true
}

output "ci_grafana_service_token_client_id" {
  description = "CI service token client ID for Grafana"
  value       = cloudflare_zero_trust_access_service_token.ci_grafana.client_id
  sensitive   = true
}

output "ci_grafana_service_token_client_secret" {
  description = "CI service token client secret for Grafana"
  value       = cloudflare_zero_trust_access_service_token.ci_grafana.client_secret
  sensitive   = true
}
