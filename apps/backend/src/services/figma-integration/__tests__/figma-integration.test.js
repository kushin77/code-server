...
describe('FigmaIntegrationService', () => {
    ...
    describe('initialization', () => {
        it('should initialize with database schema', async () => {
            ...
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('CREATE TABLE IF NOT EXISTS figma_design_tokens'));
        });
    ...
    describe('CSS variables', () => {
        ...
        it('should set CSS variables', async () => {
            ...
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO css_variables'), expect.any(Array));
        });
    ...
    describe('token mappings', () => {
        it('should map Figma tokens to CSS variables', async () => {
            ...
            const mapping = await service.mapTokenToCSSVariable('color-primary', 'primary', '--color-primary', '#007AFF');
        ...
        it('should detect token mismatches', async () => {
            ...
            const mapping = await service.mapTokenToCSSVariable('color-primary', 'primary', '--color-primary', '#0066FF');
        ...
        it('should filter mismatches when requested', async () => {
            ...
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('WHERE mismatch = TRUE'));
        });
    });
    describe('Figma frames', () => {
        it('should save Figma frames', async () => {
            ...
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO figma_frames'), expect.any(Array));
        });
    ...
    describe('comments - Figma', () => {
        it('should add Figma comments', async () => {
            ...
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO figma_comments'), expect.any(Array));
        });
        ...
        it('should filter comments by frame', async () => {
            ...
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('WHERE file_id = $1 AND frame_id = $2'), expect.any(Array));
        });
    });
    describe('comments - IDE', () => {
        it('should add IDE comments', async () => {
            ...
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO ide_comments'), expect.any(Array));
        });
    ...
    describe('comment synchronization', () => {
        it('should sync IDE comments to Figma', async () => {
            ...
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('UPDATE ide_comments'), expect.arrayContaining(['frame-1']));
        });
        it('should sync Figma comments to IDE', async () => {
            ...
            expect(count).toBe(1);
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('UPDATE figma_comments SET synced_to_ide = TRUE'), expect.any(Array));
        });
        it('should filter sync by frame', async () => {
            mockClient.query.mockResolvedValueOnce({ rows: [], rowCount: 0 });
            await service.syncCommentsFromFigma('file-1', 'frame-1');
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('AND frame_id = $2'), expect.any(Array));
        });
    });
...
//# sourceMappingURL=figma-integration.test.js.map