...
import { buildSafeWorkspaceRestorePlan, clearWorkspaceSessionSnapshot, createWorkspaceSessionSnapshot, DEFAULT_RESTORE_PREFERENCES, migrateWorkspaceSessionSnapshot, readWorkspaceRestorePreferences, readWorkspaceSessionSnapshot, scheduleWorkspaceSessionPersist, writeWorkspaceRestorePreferences, writeWorkspaceSessionSnapshot, } from '../workspaceSessionPersistence';
class MemoryStorage {
    constructor() {
        this.store = new Map();
    }
...
//# sourceMappingURL=workspaceSessionPersistence.test.js.map