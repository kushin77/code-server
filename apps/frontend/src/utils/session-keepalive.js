 ...
 */
import { acquireRefreshLock, releaseRefreshLock, broadcastSessionRefresh, broadcastSessionExpiry, isLeader, } from './session-sync';
...
export function _resetForTesting() { lastRefreshTime = 0; }
//# sourceMappingURL=session-keepalive.js.map