...
- [x] Scale Qdrant Vector DB for multi-tenant organizational memory (2-node cluster, replication_factor=2, payload indexes: scripts/phase6/deploy-qdrant-cluster.sh)
