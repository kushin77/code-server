...
- Name: kushnir-cloud-appsmith-login.spec.ts >> kushnir.cloud Appsmith login path >> auth reset response includes cookie/site-data clearing headers
- Location: specs\kushnir-cloud-appsmith-login.spec.ts:204:7

# Error details

```
Error: apiRequestContext.get: write EPROTO D0A10000:error:0A000438:SSL routines:ssl3_read_bytes:tlsv1 alert internal error:openssl\ssl\record\rec_layer_s3.c:916:SSL alert number 80
