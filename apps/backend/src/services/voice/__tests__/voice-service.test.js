...
describe('VoiceChannelService', () => {
    ...
    describe('Configuration', () => {
        it('should update configuration', () => {
            service.updateConfig({ maxChannelsPerWorkspace: 100 }, 'user-45', '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should emit config-updated event', () => {
            return new Promise((resolve) => {
                ...
                service.updateConfig({ enableRecording: false }, 'user-46', '192.168.1.1', 'Mozilla/5.0');
            });
        });
    });
    describe('Shutdown', () => {
