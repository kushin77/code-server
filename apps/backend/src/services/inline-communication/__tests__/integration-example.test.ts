...
import InlineCommunicationService, { CodeLocation, InlineCommentThread } from '../index';
import { createInlineCommunicationExampleApp } from '../integration-example';

describe('InlineCommunicationService', () => {
  let service: InlineCommunicationService;
  ...
  describe('Thread Creation', () => {
    ...
    it('should emit thread-created event', () => {
      ...
      let emittedThread: InlineCommentThread | null = null;
  ...
  describe('Comment Management', () => {
    ...
    it('should emit comment-added event', () => {
      ...
      expect((emittedEvent as any).threadId).toBe(threadId);
    });
  ...
  describe('Code Refactoring', () => {
    it('should relocate threads when code refactors', () => {
      const oldLocation: CodeLocation = {
        filePath: 'src/old.ts',
        startLine: 10,
        endLine: 20,
    ...
    it('should emit threads-relocated event', () => {
      ...
      expect(emittedEvent).not.toBeNull();
      expect((emittedEvent as any).count).toBe(1);
    });
  });
