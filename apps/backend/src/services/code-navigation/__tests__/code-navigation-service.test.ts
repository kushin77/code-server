...
import { CodeSymbol, SymbolReference, NavigationContext } from '../types.js';

describe('Code Navigation Service', () => {
  let service: CodeNavigationService;

  beforeEach(() => {
    (CodeNavigationService as any).reset();
  ...
  describe('Initialization', () => {
    it('should initialize service', () => {
      ...
      expect((service as any).symbols).toBeDefined();
  ...
  describe('Update Symbol', () => {
    it('should update symbol successfully', () => {
      ...
      const updateResult = service.updateSymbol(
  ...
  describe('Delete Symbol', () => {
    it('should delete symbol successfully', () => {
      ...
      const deleteResult = service.deleteSymbol(
        indexResult.symbolId!,
        'user1',
        '192.168.1.1',
        'Mozilla'
  ...
  describe('Track Navigation', () => {
    it('should track user navigation', () => {
      ...
      const result = service.trackNavigation(
        indexResult1.symbolId!,
        indexResult2.symbolId!,
        'user1',
        '192.168.1.1',
        'Mozilla'
      );
