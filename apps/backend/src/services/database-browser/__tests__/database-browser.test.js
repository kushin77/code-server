...
describe('DatabaseBrowserService', () => {
    ...
    it('should record query in history on execution', async () => {
        ...
        expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO query_history'), expect.any(Array));
    });
});
//# sourceMappingURL=database-browser.test.js.map