...
import service from '../session-recording-service';
describe('SessionRecordingService', () => {
    ...
    describe('startRecording', () => {
        ...
        it('should emit recordingStarted event', () => {
            ...
            expect(spy).toHaveBeenCalledWith('recordingStarted', expect.objectContaining({
    ...
    describe('recordFileChange', () => {
        ...
        it('should group changes by timestamp', () => {
            const recording = service.startRecording('session-123', 'user1', 'workspace-123');
            const now = Date.now();
            const change1 = { timestamp: now, path: '/file1.ts', type: 'create' };
            const change2 = { timestamp: now, path: '/file2.ts', type: 'create' };
    ...
    describe('recordTerminalEvent', () => {
        ...
        it('should record multiple terminal events', () => {
            ...
            const event1 = { timestamp, terminalId: 'term-1', type: 'input', data: 'ls' };
            const event2 = { timestamp, terminalId: 'term-1', type: 'output', data: 'file.ts' };
    ...
    describe('stopRecording', () => {
        ...
        it('should emit recordingStopped event', () => {
            ...
            const recording = service.startRecording('session-123', 'user1', 'workspace-123');
            service.stopRecording(recording.id);
            expect(spy).toHaveBeenCalledWith('recordingStopped', expect.objectContaining({
    ...
    describe('deleteRecording', () => {
        ...
        it('should emit recordingDeleted event', () => {
            ...
            expect(spy).toHaveBeenCalledWith('recordingDeleted', expect.objectContaining({
                recordingId: recording.id,
            }));
        });
    });
    ...
    describe('Sharing', () => {
        ...
        it('should emit shareTokenGenerated event', () => {
            ...
            expect(spy).toHaveBeenCalledWith('shareTokenGenerated', expect.objectContaining({
                recordingId: recording.id,
...
//# sourceMappingURL=session-recording-service.test.js.map