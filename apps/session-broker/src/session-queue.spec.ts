...
import {
  compareSessionQueueDescriptors,
...
describe('session queue helpers', () => {
  it('normalizes queue lanes and orders fast lanes first', () => {
    ...
    const ordered = [
      { sessionId: 'b', queueLane: 'standard' as const, queuedAt: 20, sequence: 2 },
      { sessionId: 'a', queueLane: 'fast' as const, queuedAt: 10, sequence: 1 },
      { sessionId: 'c', queueLane: 'fast' as const, queuedAt: 15, sequence: 3 },
