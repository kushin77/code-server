...
import { assertReadSafeShadowReplayTraces, buildShadowReplayReport, normalizeShadowReplayMethod, } from './session-shadow-replay.js';
describe('session shadow replay helpers', () => {
    ...
    it('builds a comparative diff report with mismatch and latency regression counts', () => {
        const report = buildShadowReplayReport('sess-123', [
            {
                method: 'GET',
                path: '/healthz',
                baselineStatus: 200,
...
//# sourceMappingURL=session-shadow-replay.spec.js.map