...
let standupService: StandupSummariesService | null = null
 ...
 */
const requireService = (req: Request, res: Response, next: NextFunction) => {
  if (!standupService) {
 ...
 */
router.get('/:date', requireService, async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/:date/approve', requireService, async (req: Request, res: Response) => {
  try {
    const { date } = req.params
 ...
 */
router.post('/:date/generate', requireService, async (req: Request, res: Response) => {
  try {
    const { date } = req.params
 ...
 */
router.post('/:date/post', requireService, async (req: Request, res: Response) => {
  try {
    const { date } = req.params
 ...
 */
router.get('/', requireService, async (req: Request, res: Response) => {
  try {
