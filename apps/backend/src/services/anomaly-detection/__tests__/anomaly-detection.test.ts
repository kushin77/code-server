...
import { AnomalyDetectionEngine, AnomalyDetectionService, SessionAccessEvent } from '../index';
...
describe('AnomalyDetectionEngine', () => {
  ...
  it('should score normal behavior as low anomaly', () => {
    ...
    const normalEvent: SessionAccessEvent = {
      sessionId: 'test',
      userId: 'user2',
      timestamp: Date.now(),
      loginHour: 9,
  ...
  it('should score anomalous behavior as high', () => {
    ...
    const anomalousEvent: SessionAccessEvent = {
      sessionId: 'test',
      userId: 'user3',
      timestamp: Date.now(),
      loginHour: 3,
