...
- **Need governance policy SSOT?** Check [governance/README.md](governance/README.md)
...
- **Need a deployment checklist?** Check [ops/DEPLOYMENT-CHECKLIST.md](ops/DEPLOYMENT-CHECKLIST.md)
- **Need an audit/compliance checklist?** Check [COMPLIANCE-CHECKLIST.md](COMPLIANCE-CHECKLIST.md)
- **Need operational SSOT index?** Check [ops/OPERATIONS-INDEX.md](ops/OPERATIONS-INDEX.md)
- **Need platform SLO baselines?** Check [slos/README.md](slos/README.md)
- **Need security hardening baseline?** Check [SECURITY-HARDENING-GUIDE.md](SECURITY-HARDENING-GUIDE.md)
