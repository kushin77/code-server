...
- Timestamp (UTC): 2026-04-21T12:21:03Z
- Strict mode: 1
- Run ESLint checks: 1
...
apps/frontend/src/types/repo-card.ts:64 - RepoCardActionResult
apps/frontend/src/types/repo-card.ts:78 - HomeViewCache
apps/frontend/src/types/repo-card.ts:91 - HomeViewConfig
...
apps/frontend/src/utils/session-keepalive.ts:145 - initSessionKeepalive
apps/frontend/src/utils/session-sync.ts:191 - broadcastRefresh
apps/frontend/src/utils/session-sync.ts:222 - broadcastExpiry
...
apps/frontend/src/utils/ws-session-handoff.ts:77 - setupWSAutoHandoff
```
