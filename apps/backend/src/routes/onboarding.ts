 ...
 */
router.get('/sessions/:sessionId', validateSession, (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/sessions/:sessionId/execute-step', validateSession, async (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params
 ...
 * Skip current step
 */
router.post('/sessions/:sessionId/skip-step', validateSession, (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params
 ...
 * Move to next step
 */
router.post('/sessions/:sessionId/next-step', validateSession, (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params
 ...
 */
router.post('/sessions/:sessionId/prev-step', validateSession, (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params
 ...
 * Get current step
 */
router.get('/sessions/:sessionId/current-step', validateSession, (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params
 ...
 * Complete onboarding
 */
router.post('/sessions/:sessionId/complete', validateSession, async (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params
 ...
 */
router.post('/sessions/:sessionId/auto-run-all', validateSession, async (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params
    const session = onboardingService.getSession(sessionId)!
