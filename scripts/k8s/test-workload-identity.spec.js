...
describe('Workload Identity Token Exchange Flow', () => {
    ...
    it('should return JWT with correct structure', () => {
        ...
        const mockToken = {
            access_token: 'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJzeXN0ZW06c2VydmljZWFjY291bnQ6cHJvZDpjb2RlLXNlcnZlciIsImF1ZCI6ImNvZGUtc2VydmVyIiwiaXNzIjoiaHR0cHM6Ly9vaWRjLmt1c2huaXIuY2xvdWQiLCJpYXQiOjE3MDAwMDAwMDAsImV4cCI6MTcwMDAzNjAwMH0.sig',
            token_type: 'Bearer',
            expires_in: 3600,
        };
...
//# sourceMappingURL=test-workload-identity.spec.js.map