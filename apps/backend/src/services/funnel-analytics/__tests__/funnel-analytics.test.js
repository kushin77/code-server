...
describe('FunnelAnalyticsService', () => {
    ...
    it('should record event with metadata', async () => {
        ...
        expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO funnel_events'), expect.arrayContaining([expect.any(String), expect.any(String), expect.any(String), expect.any(Date), expect.stringContaining('referrer')]));
    });
...
//# sourceMappingURL=funnel-analytics.test.js.map