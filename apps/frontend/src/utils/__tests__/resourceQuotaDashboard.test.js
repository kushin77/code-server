...
describe('resourceQuotaDashboard', () => {
    it('loads and normalizes the monthly cost dashboard payloads', async () => {
                        ...
                        data: [
                            {
                                ...
                                triggeredAt: 1735776000000,
                                acknowledgedAt: 1735862400000,
        ...
        const result = await loadResourceCostDashboard(fetchMock);
...
//# sourceMappingURL=resourceQuotaDashboard.test.js.map