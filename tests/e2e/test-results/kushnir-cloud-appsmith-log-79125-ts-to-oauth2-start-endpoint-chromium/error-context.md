...
- Name: kushnir-cloud-appsmith-login.spec.ts >> kushnir.cloud Appsmith login path >> unauthenticated root redirects to oauth2 start endpoint
- Location: specs\kushnir-cloud-appsmith-login.spec.ts:85:7

# Error details

```
Error: apiRequestContext.get: write EPROTO B4BF0000:error:0A000438:SSL routines:ssl3_read_bytes:tlsv1 alert internal error:openssl\ssl\record\rec_layer_s3.c:916:SSL alert number 80

Call log:
  - → GET https://kushnir.cloud/
