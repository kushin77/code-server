...
import {
  ...
  getPreviewEnvironmentService,
} from '../preview-service.js';
import { PreviewBuildConfig } from '../types.js';

describe('Preview Environment Service', () => {
  let previewService: PreviewEnvironmentService;
  ...
  describe('Provisioning', () => {
    ...
    it('should emit environment-created event', async () => {
      ...
      return new Promise<void>((resolve) => {
        ...
        previewService.provisionEnvironment(
          789,
          'feature/test',
          'test123',
          'kushin77/code-server',
  ...
  describe('Getting Environments', () => {
    beforeEach(async () => {
      ...
      await previewService.provisionEnvironment(
        101,
        'feature/one',
        'abc1',
        'kushin77/code-server',
  ...
  describe('Destruction', () => {
    ...
    beforeEach(async () => {
      ...
      envId = await previewService.provisionEnvironment(
        201,
        'feature/destroy',
        'destroy123',
        'kushin77/code-server',
