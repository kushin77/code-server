...
describe('NotificationPriorityEngineService', () => {
    ...
    beforeEach(async () => {
        ...
        service = new NotificationPriorityEngineService(mockPool, mockAuditService);
    ...
    describe('initialization', () => {
        it('should initialize and create tables', async () => {
            ...
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('CREATE TABLE IF NOT EXISTS notification_priority_queue'));
        });
        it('should create indices', async () => {
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('CREATE INDEX IF NOT EXISTS idx_priority_queue_user'));
        });
    });
    describe('enqueueNotification', () => {
        ...
        it('should persist notification to database', async () => {
            ...
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO notification_priority_queue'), expect.any(Array));
        });
        it('should log to audit service', async () => {
            ...
            await service.enqueueNotification('user1', notification);
            expect(mockAuditService.logAudit).toHaveBeenCalledWith(expect.objectContaining({
        ...
        it('should throttle excessive notifications', async () => {
            ...
            const service2 = new NotificationPriorityEngineService(mockPool, mockAuditService);
    ...
    describe('EventEmitter integration', () => {
        it('should emit notificationEnqueued event', (done) => {
            service.on('notificationEnqueued', (notification) => {
...
//# sourceMappingURL=notification-priority-engine-service.test.js.map