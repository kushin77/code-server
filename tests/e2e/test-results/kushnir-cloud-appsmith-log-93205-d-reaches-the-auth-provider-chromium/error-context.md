...
- Name: kushnir-cloud-appsmith-login.spec.ts >> kushnir.cloud Appsmith login path >> interactive login starts from kushnir.cloud and reaches the auth provider
- Location: specs\kushnir-cloud-appsmith-login.spec.ts:116:7

# Error details

```
Error: apiRequestContext.get: write EPROTO 90530000:error:0A000438:SSL routines:ssl3_read_bytes:tlsv1 alert internal error:openssl\ssl\record\rec_layer_s3.c:916:SSL alert number 80
