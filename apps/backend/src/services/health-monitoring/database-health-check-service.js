...
export class DatabaseHealthCheckService extends EventEmitter {
    ...
    async checkPgbouncer() {
        ...
        try {
            ...
            const isHealthy = await this.simulateConnectivity(this.config.pgbouncer.host, this.config.pgbouncer.port);
    ...
    async checkPostgresql() {
        ...
        try {
            ...
            const isHealthy = await this.simulateConnectivity(this.config.postgres.host, this.config.postgres.port);
            const responseTime = Date.now() - startTime;
     ...
     */
    async simulateConnectivity(host, port) {
...
//# sourceMappingURL=database-health-check-service.js.map