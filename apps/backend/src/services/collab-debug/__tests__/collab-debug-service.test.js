...
describe('CollaborativeDebugService', () => {
    let service;
    beforeEach(() => {
        CollaborativeDebugService.reset();
    ...
    describe('Debug Session Creation', () => {
        it('should create debug session', () => {
            const session = service.createDebugSession('user-1', 'user1@example.com', 'dap-session-1', false, undefined, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should create shared debug session', () => {
            const session = service.createDebugSession('user-3', 'user3@example.com', 'dap-3', true, 10, '192.168.1.1', 'Mozilla/5.0');
            expect(session.isShared).toBe(true);
            expect(session.maxParticipants).toBe(10);
        });
        it('should track session creation timestamp', () => {
            const now = Date.now();
            const session = service.createDebugSession('user-4', 'user4@example.com', 'dap-4', false, undefined, '192.168.1.1', 'Mozilla/5.0');
            expect(session.createdAt).toBeGreaterThanOrEqual(now);
        });
    });
    describe('Session Participants', () => {
        it('should join debug session', () => {
            const session = service.createDebugSession('user-5', 'user5@example.com', 'dap-5', true, 10, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should fail to join non-shared session', () => {
            const session = service.createDebugSession('user-7', 'user7@example.com', 'dap-7', false, undefined, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should emit participant-joined event', () => {
            return new Promise((resolve) => {
                const session = service.createDebugSession('user-9', 'user9@example.com', 'dap-9', true, 10, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should leave debug session', () => {
            const session = service.createDebugSession('user-11', 'user11@example.com', 'dap-11', true, 10, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should emit participant-left event', () => {
            return new Promise((resolve) => {
                const session = service.createDebugSession('user-13', 'user13@example.com', 'dap-13', true, 10, '192.168.1.1', 'Mozilla/5.0');
    ...
    describe('Breakpoints', () => {
        it('should set breakpoint', () => {
            const session = service.createDebugSession('user-15', 'user15@example.com', 'dap-15', false, undefined, '192.168.1.1', 'Mozilla/5.0');
            const result = service.setBreakpoint({
                userId: 'user-15',
                userEmail: 'user15@example.com',
                location: { filePath: 'app.ts', line: 42 },
            }, session.id, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should emit breakpoint-set event', () => {
            return new Promise((resolve) => {
                const session = service.createDebugSession('user-16', 'user16@example.com', 'dap-16', false, undefined, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should clear breakpoint', () => {
            const session = service.createDebugSession('user-17', 'user17@example.com', 'dap-17', false, undefined, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should emit breakpoint-cleared event', () => {
            return new Promise((resolve) => {
                const session = service.createDebugSession('user-18', 'user18@example.com', 'dap-18', false, undefined, '192.168.1.1', 'Mozilla/5.0');
                const setResult = service.setBreakpoint({
                    userId: 'user-18',
        ...
        it('should support conditional breakpoints', () => {
            const session = service.createDebugSession('user-19', 'user19@example.com', 'dap-19', false, undefined, '192.168.1.1', 'Mozilla/5.0');
            const result = service.setBreakpoint({
                userId: 'user-19',
        ...
        it('should support logpoints', () => {
            const session = service.createDebugSession('user-20', 'user20@example.com', 'dap-20', false, undefined, '192.168.1.1', 'Mozilla/5.0');
            const result = service.setBreakpoint({
                userId: 'user-20',
    ...
    describe('Thread Control', () => {
        it('should continue thread', () => {
            const session = service.createDebugSession('user-21', 'user21@example.com', 'dap-21', false, undefined, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should emit thread-continued event', () => {
            return new Promise((resolve) => {
                const session = service.createDebugSession('user-22', 'user22@example.com', 'dap-22', false, undefined, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should step thread', () => {
            const session = service.createDebugSession('user-23', 'user23@example.com', 'dap-23', false, undefined, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should emit thread-stepped event', () => {
            return new Promise((resolve) => {
                const session = service.createDebugSession('user-24', 'user24@example.com', 'dap-24', false, undefined, '192.168.1.1', 'Mozilla/5.0');
    ...
    describe('Variables and Expressions', () => {
        it('should eval expression', () => {
            const session = service.createDebugSession('user-25', 'user25@example.com', 'dap-25', false, undefined, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should emit expression-evaluated event', () => {
            return new Promise((resolve) => {
                const session = service.createDebugSession('user-26', 'user26@example.com', 'dap-26', false, undefined, '192.168.1.1', 'Mozilla/5.0');
    ...
    describe('Session Termination', () => {
        it('should terminate debug session', () => {
            const session = service.createDebugSession('user-27', 'user27@example.com', 'dap-27', false, undefined, '192.168.1.1', 'Mozilla/5.0');
        ...
        it('should emit debug-session-terminated event', () => {
            return new Promise((resolve) => {
                const session = service.createDebugSession('user-28', 'user28@example.com', 'dap-28', false, undefined, '192.168.1.1', 'Mozilla/5.0');
    ...
    describe('Statistics', () => {
        ...
        it('should track total breakpoints', () => {
            const session = service.createDebugSession('user-32', 'user32@example.com', 'dap-32', false, undefined, '192.168.1.1', 'Mozilla/5.0');
            service.setBreakpoint({
                userId: 'user-32',
    ...
    describe('Shutdown', () => {
        it('should shutdown service', () => {
            const session = service.createDebugSession('user-35', 'user35@example.com', 'dap-35', false, undefined, '192.168.1.1', 'Mozilla/5.0');
            service.shutdown();
            expect(service.getDebugSession(session.id)).toBeNull();
        });
...
//# sourceMappingURL=collab-debug-service.test.js.map