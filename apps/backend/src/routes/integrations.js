...
import { getIntegrationHub } from "../services/integrations/integration-hub.js";
const router = Router();
 ...
 * }
 */
router.post("/:integrationId/event", async (req, res) => {
    try {
        const { integrationId } = req.params;
 ...
 */
router.post("/:integrationId/webhook", (req, res) => {
    try {
        const { integrationId } = req.params;
