...
import { OnboardingService, OnboardingSession, OnboardingStep } from '../onboarding-service'
...
describe('OnboardingService', () => {
  ...
  describe('Step Execution', () => {
    ...
    it('should error on invalid step execution', async () => {
      ...
      await expect(service.executeStep(invalidSessionId, true)).rejects.toThrow(
        'Session not found',
      )
    })
  })
  ...
  describe('Error Handling', () => {
    ...
    it('should handle complete onboarding on non-existent session', async () => {
      await expect(service.completeOnboarding('non-existent')).rejects.toThrow(
        'Session not found',
      )
    })
