...
import type { CheckpointRequest, RestoreRequest } from '../types.js';

describe('HibernationService', () => {
  let service: HibernationService;
  ...
  describe('session restore', () => {
    it('should restore session from checkpoint', async () => {
      ...
      const checkpointReq: CheckpointRequest = {
        sessionId: 'sess-r1',
        userId: 'user-1',
        workspaceId: 'workspace-1',
        force: false,
      ...
      const restoreReq: RestoreRequest = {
  ...
  describe('multiple users', () => {
    ...
    it('should isolate audit logs by user', async () => {
      ...
      const checkpointReq1: CheckpointRequest = {
        sessionId: 'session-1',
        userId: 'user-1',
        workspaceId: 'workspace-1',
        force: false,
      ...
      const checkpointReq2: CheckpointRequest = {
        sessionId: 'session-2',
        userId: 'user-2',
