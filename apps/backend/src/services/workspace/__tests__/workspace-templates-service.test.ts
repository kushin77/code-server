...
import service, { WorkspaceTemplate, ProvisioningProgress } from '../workspace-templates-service';
...
describe('WorkspaceTemplatesService', () => {
  ...
  describe('createTemplate', () => {
    ...
    it('should support all template categories', () => {
      const categories: ('full-stack' | 'frontend' | 'backend' | 'data-science' | 'custom')[] = [
        'full-stack',
        'frontend',
        'backend',
        'data-science',
  ...
  describe('getStatistics', () => {
    beforeEach(() => {
      ...
      // Simulate usage
      if (t1) t1.usageCount = 10;
      if (t2) t2.usageCount = 5;
      if (t3) t3.usageCount = 15;
    });
