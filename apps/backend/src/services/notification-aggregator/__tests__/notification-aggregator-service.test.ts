...
describe('Notification Aggregator Service', () => {
  let service: NotificationAggregator;
  ...
  describe('Initialization', () => {
    it('should initialize service', () => {
      ...
      expect((service as any).notifications).toBeDefined();
      expect((service as any).aggregationRules).toBeDefined();
    });
  ...
  describe('Aggregation Rules', () => {
    ...
    it('should update aggregation rule', () => {
      ...
      const result = service.updateAggregationRule(
        created.ruleId!,
        { enabled: false },
        'user1',
        '192.168.1.1',
  ...
  describe('Delivery Policies', () => {
    ...
    it('should update delivery policy', () => {
      ...
      const result = service.updateDeliveryPolicy(
        created.policyId!,
        { enabled: false },
        'user1',
        '192.168.1.1',
  ...
  describe('Batch Operations', () => {
    it('should batch send notifications', () => {
      ...
      const result = service.batchSendNotifications(
        [notif1.notificationId!],
        'user1',
        '192.168.1.1',
        'Mozilla'
  ...
  describe('Shutdown', () => {
    it('should shutdown service cleanly', () => {
      ...
      expect((service as any).notifications.size).toBe(0);
      expect((service as any).aggregationRules.size).toBe(0);
    });
  });
});
