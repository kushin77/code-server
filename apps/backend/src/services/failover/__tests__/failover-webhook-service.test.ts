...
import FailoverWebhookService, { FailoverConfig, AlertPayload, FailoverEvent } from '../failover-webhook-service';

describe('FailoverWebhookService', () => {
  let service: FailoverWebhookService;
  let config: Partial<FailoverConfig>;
