...
import { IntegrationHub, type IntegrationConfig } from "../integration-hub"
...
describe("IntegrationHub", () => {
  ...
  describe("getStatus", () => {
    ...
    it("should track error count", async () => {
      const result = hub.registerIntegration("invalid-integration" as any, {
        enabled: false,
      })
  ...
  describe("Integration Types", () => {
    it("should support all 10 integration types", () => {
      const types = ["github", "linear", "jira", "slack", "circleci", "github-actions", "figma", "sentry", "pagerduty", "jaeger"] as const
