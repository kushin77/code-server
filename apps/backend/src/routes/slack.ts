 ...
 */
function verifySlackMiddleware(req: Request, res: Response, next: NextFunction): void {
 ...
 */
router.get('/channels/:channelId/sessions', async (req: Request, res: Response) => {
  try {
