 ...
 */
router.post('/sessions/:sessionId/recording/start', (req, res) => {
    try {
 ...
 */
router.post('/recordings/:recordingId/pause', (req, res) => {
    try {
        const { recordingId } = req.params;
 ...
 */
router.post('/recordings/:recordingId/resume', (req, res) => {
    try {
        const { recordingId } = req.params;
 ...
 */
router.get('/recordings/:recordingId', (req, res) => {
    try {
        const { recordingId } = req.params;
        const recording = service.getRecording(recordingId);
        if (!recording) {
 ...
 */
router.delete('/recordings/:recordingId', (req, res) => {
    try {
        const { recordingId } = req.params;
 ...
 */
router.get('/sessions/:sessionId/recordings', (req, res) => {
    try {
        const { sessionId } = req.params;
 ...
 */
router.get('/users/:userId/recordings', (req, res) => {
    try {
 ...
 */
router.post('/recordings/:recordingId/file', (req, res) => {
    try {
        const { recordingId } = req.params;
 ...
 */
router.post('/recordings/:recordingId/terminal', (req, res) => {
    try {
        const { recordingId } = req.params;
 ...
 */
router.post('/recordings/:recordingId/debug', (req, res) => {
    try {
        const { recordingId } = req.params;
        const event = req.body;
 ...
 */
router.post('/recordings/:recordingId/chat', (req, res) => {
    try {
        const { recordingId } = req.params;
 ...
 */
router.post('/recordings/:recordingId/playback/start', (req, res) => {
    try {
        const { recordingId } = req.params;
 ...
 */
router.post('/recordings/:recordingId/playback/pause', (req, res) => {
    try {
        const { recordingId } = req.params;
 ...
 */
router.post('/recordings/:recordingId/playback/resume', (req, res) => {
    try {
        const { recordingId } = req.params;
 ...
 */
router.patch('/recordings/:recordingId/playback/speed', (req, res) => {
    try {
        const { recordingId } = req.params;
 ...
 */
router.post('/recordings/:recordingId/playback/seek', (req, res) => {
    try {
        const { recordingId } = req.params;
 ...
 */
router.patch('/recordings/:recordingId/playback/layer/:layer', (req, res) => {
    try {
        ...
        const result = service.toggleLayer(recordingId, layer);
        if (!result) {
            return res.status(404).json({
                success: false,
                error: 'Playback not found',
 ...
 */
router.post('/recordings/:recordingId/playback/stop', (req, res) => {
    try {
        const { recordingId } = req.params;
 ...
 */
router.get('/recordings/:recordingId/playback', (req, res) => {
    try {
        const { recordingId } = req.params;
        const state = service.getPlaybackState(recordingId);
        if (!state) {
 ...
 */
router.post('/recordings/:recordingId/share', (req, res) => {
    try {
        const { recordingId } = req.params;
 ...
 */
router.get('/recordings/share/:token', (req, res) => {
    try {
 ...
 */
router.delete('/recordings/:recordingId/share', (req, res) => {
    try {
        const { recordingId } = req.params;
 ...
 */
router.post('/recordings/:recordingId/export', async (req, res) => {
    try {
        const { recordingId } = req.params;
 ...
 */
router.get('/recordings/:recordingId/frame/:timeMs', (req, res) => {
    try {
 ...
 */
router.get('/recordings/stats/all', (req, res) => {
    try {
