...
import { SLOTrackingEngine, getSLOTrackingService, SLOTrackingService, } from '../index';
...
describe('SLOTrackingService', () => {
    ...
    describe('Recording and Retrieval', () => {
        it('should record sync events with complete data', () => {
            const service = getSLOTrackingService();
            const metric = service.recordSync('session-1', 'edit', 75, 2, undefined);
...
//# sourceMappingURL=slo-tracking.test.js.map