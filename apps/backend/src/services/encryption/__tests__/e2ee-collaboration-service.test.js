...
describe("E2EECollaborationService", () => {
    ...
    describe("Message Encryption/Decryption", () => {
        ...
        it("should decrypt encrypted message", async () => {
            ...
            const decrypted = await service.decryptMessage(sessionId, encrypted.messageId, encrypted.encryptedMessage, "user-123");
        ...
        it("should fail to decrypt with wrong message ID", async () => {
            ...
            const encrypted = await service.encryptMessage(sessionId, message, "user-123");
            const decrypted = await service.decryptMessage(sessionId, "wrong-message-id", encrypted.encryptedMessage, "user-123");
        ...
        it("should fail to decrypt with non-existent session", async () => {
            ...
            const decrypted = await service.decryptMessage("non-existent-session", encrypted.messageId, encrypted.encryptedMessage, "user-123");
            expect(decrypted.success).toBe(false);
        });
    ...
    describe("Multiple Sessions", () => {
        ...
        it("should isolate messages between sessions", async () => {
            ...
            const wrongDecrypt = await service1.decryptMessage(session1.sessionId, encrypted2.messageId, encrypted2.encryptedMessage, "user-1");
...
//# sourceMappingURL=e2ee-collaboration-service.test.js.map