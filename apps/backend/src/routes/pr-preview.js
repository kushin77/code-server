 ...
 */
router.get("/:previewId/health", (req, res) => {
    try {
        const { previewId } = req.params;
 ...
 * }
 */
router.post("/:previewId/mark-for-destruction", (req, res) => {
    try {
        const { previewId } = req.params;
 ...
 */
router.delete("/:previewId", (req, res) => {
    try {
        const { previewId } = req.params;
 ...
 */
router.get("/repo/:owner/:repo/stats", (req, res) => {
    try {
        const { owner, repo } = req.params;
 ...
 */
router.get("/repo/:owner/:repo/billing", (req, res) => {
    try {
        const { owner, repo } = req.params;
        const costPerHour = parseFloat(req.query.costPerHour) || 2.5;
