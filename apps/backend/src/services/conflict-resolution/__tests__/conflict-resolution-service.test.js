...
describe('Conflict Resolution Service', () => {
    ...
    describe('Initialization', () => {
        it('should initialize service', () => {
            ...
            expect(service.resolutions).toBeDefined();
        });
    ...
    describe('Batch Resolve Conflicts', () => {
        it('should batch resolve conflicts', () => {
            ...
            const batchResult = service.batchResolveConflicts([result1.conflictId], 'keep-local', 'user1', '192.168.1.1', 'Mozilla');
    ...
    describe('Shutdown', () => {
        it('should shutdown service cleanly', () => {
            service.shutdown();
            expect(service.conflicts.size).toBe(0);
        });
    });
...
//# sourceMappingURL=conflict-resolution-service.test.js.map