...
import { CRDTCompactionService } from '../compaction-service';
...
describe('CRDTCompactionService', () => {
    ...
    describe('Document Compaction', () => {
        ...
        it('should keep recent operations after snapshot', () => {
            ...
            const allOps = Array.from({ length: 10 }, (_, i) => ({
                id: `op-${i}`,
                clientId: 'client-1',
    ...
    describe('Compaction Thresholds', () => {
        it('should determine if compaction needed by operation count', () => {
            const operations = Array.from({ length: 15000 }, (_, i) => ({
                id: `op-${i}`,
                clientId: 'client-1',
                timestamp: Date.now(),
                type: 'insert',
...
//# sourceMappingURL=compaction-service.test.js.map