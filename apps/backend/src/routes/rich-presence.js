 ...
 */
router.get('/presence/online/all', (req, res) => {
    try {
 ...
 */
router.get('/presence/file', (req, res) => {
    try {
 ...
 */
router.get('/presence/task', (req, res) => {
    try {
        const { id } = req.query;
        if (!id) {
            return res.status(400).json({
 ...
 */
router.get('/presence/stats/all', (req, res) => {
    try {
 ...
 */
router.get('/presence/count/status', (req, res) => {
    try {
 ...
 */
router.patch('/presence/:userId/status', (req, res) => {
    try {
 ...
 */
router.patch('/presence/:userId/file', (req, res) => {
    try {
        const { userId } = req.params;
 ...
 */
router.patch('/presence/:userId/function', (req, res) => {
    try {
        const { userId } = req.params;
 ...
 */
router.patch('/presence/:userId/task', (req, res) => {
    try {
        const { userId } = req.params;
 ...
 */
router.patch('/presence/:userId/custom-status', (req, res) => {
    try {
        const { userId } = req.params;
 ...
 */
router.delete('/presence/:userId/custom-status', (req, res) => {
    try {
        const { userId } = req.params;
 ...
 */
router.patch('/presence/:userId/cursor', (req, res) => {
    try {
        const { userId } = req.params;
        const { x, y } = req.body;
 ...
 */
router.post('/presence/query', (req, res) => {
    try {
 ...
 */
router.get('/presence/workspace/:workspaceId', (req, res) => {
    try {
 ...
 */
router.post('/presence/:userId/broadcast', (req, res) => {
    try {
        const { userId } = req.params;
 ...
 */
router.delete('/presence/:userId', (req, res) => {
    try {
        const { userId } = req.params;
...
//# sourceMappingURL=rich-presence.js.map