...
describe('Code Review Comments Service', () => {
  let service: CodeReviewCommentsService;

  beforeEach(() => {
    (CodeReviewCommentsService as any).reset();
  ...
  describe('Initialization', () => {
    it('should initialize service and emit initialized event', () => {
      ...
      expect((service as any).threads).toBeDefined();
      expect((service as any).threadsByReview).toBeDefined();
    });
