...
- Name: oauth-login.spec.ts >> OAuth login smoke test >> health check endpoint is reachable without auth
- Location: specs\oauth-login.spec.ts:14:7

# Error details

```
Error: page.goto: net::ERR_SSL_PROTOCOL_ERROR at https://kushnir.cloud/health
Call log:
  - navigating to "https://kushnir.cloud/health", waiting until "load"
