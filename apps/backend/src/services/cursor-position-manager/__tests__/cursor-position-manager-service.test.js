...
describe('Cursor Position Manager Service', () => {
    ...
    describe('Initialization', () => {
        it('should initialize service', () => {
            ...
            expect(service.cursors).toBeDefined();
            expect(service.fileCursors).toBeDefined();
        });
    ...
    describe('Cursor Position Updates', () => {
        it('should update cursor position', () => {
            const result = service.updateCursorPosition('user1', 'user1@example.com', 'User One', 'file1', { line: 10, column: 5 }, '192.168.1.1', 'Mozilla');
        ...
        it('should emit cursor-position-updated event', () => {
            return new Promise((resolve) => {
                ...
                service.updateCursorPosition('user1', 'user1@example.com', 'User One', 'file1', { line: 10, column: 5 }, '192.168.1.1', 'Mozilla');
            });
        });
    ...
    describe('Cursor Selection', () => {
        it('should update cursor selection', () => {
            service.updateCursorPosition('user1', 'user1@example.com', 'User One', 'file1', { line: 10, column: 5 }, '192.168.1.1', 'Mozilla');
            const result = service.updateCursorSelection('user1', 'file1', { line: 10, column: 5 }, { line: 10, column: 15 }, '192.168.1.1', 'Mozilla');
            expect(result.success).toBe(true);
        });
        it('should emit cursor-selection-updated event', () => {
            return new Promise((resolve) => {
                ...
                service.updateCursorSelection('user1', 'file1', { line: 10, column: 5 }, { line: 10, column: 15 }, '192.168.1.1', 'Mozilla');
            });
        });
    });
    // Query Tests
    describe('Cursor Queries', () => {
        it('should get cursors in file', () => {
            service.updateCursorPosition('user1', 'user1@example.com', 'User One', 'file1', { line: 10, column: 5 }, '192.168.1.1', 'Mozilla');
            service.updateCursorPosition('user2', 'user2@example.com', 'User Two', 'file1', { line: 15, column: 10 }, '192.168.1.1', 'Mozilla');
            const cursors = service.getCursorsInFile('file1');
            expect(cursors.length).toBeGreaterThanOrEqual(2);
        });
        it('should get cursors by user', () => {
            service.updateCursorPosition('user1', 'user1@example.com', 'User One', 'file1', { line: 10, column: 5 }, '192.168.1.1', 'Mozilla');
            service.updateCursorPosition('user1', 'user1@example.com', 'User One', 'file2', { line: 20, column: 10 }, '192.168.1.1', 'Mozilla');
    ...
    describe('Synchronization', () => {
        ...
        it('should broadcast cursor update', () => {
            const result = service.broadcastCursorUpdate('file1', [
                {
                    userId: 'user1',
                    fileId: 'file1',
        ...
        it('should emit cursor-broadcast event', () => {
            return new Promise((resolve) => {
                ...
                service.broadcastCursorUpdate('file1', [
                    {
                        userId: 'user1',
                        fileId: 'file1',
                        position: { line: 10, column: 5 },
    ...
    describe('Conflict Detection', () => {
        it('should detect cursor conflicts', () => {
            service.updateCursorPosition('user1', 'user1@example.com', 'User One', 'file1', { line: 10, column: 5 }, '192.168.1.1', 'Mozilla');
            service.updateCursorPosition('user2', 'user2@example.com', 'User Two', 'file1', { line: 10, column: 5 }, '192.168.1.1', 'Mozilla');
    ...
    describe('Viewport Management', () => {
        it('should update viewport', () => {
            const result = service.updateViewport('user1', 'file1', { fileId: 'file1', minLine: 0, maxLine: 50, minColumn: 0, maxColumn: 100 }, 1.0, '192.168.1.1', 'Mozilla');
            expect(result.success).toBe(true);
        });
        it('should emit viewport-updated event', () => {
            return new Promise((resolve) => {
                ...
                service.updateViewport('user1', 'file1', { fileId: 'file1', minLine: 0, maxLine: 50, minColumn: 0, maxColumn: 100 }, 1.0, '192.168.1.1', 'Mozilla');
            });
        });
        it('should get viewport', () => {
            service.updateViewport('user1', 'file1', { fileId: 'file1', minLine: 0, maxLine: 50, minColumn: 0, maxColumn: 100 }, 1.5, '192.168.1.1', 'Mozilla');
    ...
    describe('Cursor History', () => {
        it('should record cursor movement in history', () => {
            service.updateCursorPosition('user1', 'user1@example.com', 'User One', 'file1', { line: 10, column: 5 }, '192.168.1.1', 'Mozilla');
            service.updateCursorPosition('user1', 'user1@example.com', 'User One', 'file1', { line: 15, column: 10 }, '192.168.1.1', 'Mozilla');
    ...
    describe('Shutdown', () => {
        it('should shutdown service cleanly', () => {
            ...
            expect(service.fileCursors.size).toBe(0);
        });
    });
});
//# sourceMappingURL=cursor-position-manager-service.test.js.map