...
describe('ManifestValidator', () => {
    ...
    describe('Security Context Validation', () => {
        it('should enforce non-root execution', async () => {
            ...
            const result = await validator.validate(manifest);
            expect(result.errors).not.toContain(expect.stringContaining('runAsNonRoot'));
        });
        it('should warn about root execution', async () => {
            ...
            const result = await validator.validate(manifest);
            expect(result.warnings).toContain(expect.stringContaining('root'));
        });
    ...
    describe('Health Probe Validation', () => {
        ...
        it('should warn about missing probes', async () => {
            ...
            const result = await validator.validate(manifest);
            expect(result.warnings).toContain(expect.stringContaining('probe'));
        });
    });
    ...
    describe('Custom Rules', () => {
        ...
        it('should apply all custom rules', async () => {
            ...
            const result = await validator.validate(manifest);
            expect(result.errors).toContain(expect.stringContaining('namespace'));
        });
    });
  ...
  spec:
    ...
    describe('Recommendations', () => {
        it('should provide actionable recommendations', async () => {
            ...
            const result = await validator.validate(manifest);
            expect(result.recommendations).toContain(expect.stringContaining('image'));
        });
...
//# sourceMappingURL=ManifestValidator.test.js.map