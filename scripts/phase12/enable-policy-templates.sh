#!/usr/bin/env bash
# @file scripts/phase12/enable-policy-templates.sh
# @description Phase 12 - Enable policies, templates & standards
# @summary Validates compose templates and OPA policy integration.
...
PHASE_TAG="phase12-enable-policy-templates"
...
log_info "=== Phase 12 - Enable policies, templates & standards ==="
log_info "Dry-run: ${DRY_RUN}"

steps=("Enforce compose templates::scripts/ci/enforce-compose-templates.sh" "Integrate OPA policies::scripts/ci/integrate-opa-policies.sh")
results=()
ok=0; fail=0; skip=0
...
{
    printf '# Phase 12 - Enable policies, templates & standards\n\n'
    printf '%s\n\n' "Validates compose templates and OPA policy integration."
