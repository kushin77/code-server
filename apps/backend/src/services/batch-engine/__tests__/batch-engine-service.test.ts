...
describe('Batch Engine Service', () => {
  let service: BatchEngineService;
  ...
  describe('Initialization', () => {
    it('should initialize service', () => {
      ...
      expect((service as any).jobs).toBeDefined();
  ...
  describe('Task Management', () => {
    ...
    it('should remove task', () => {
      ...
      const taskResult = service.addTask(
        created.jobId!,
        {
          name: 'Task 1',
          type: 'process',
  ...
  describe('Task Retry', () => {
    it('should retry task', () => {
      ...
      const result = service.retryTask(
        created.jobId!,
        taskResult.taskId!,
        'user1',
        '192.168.1.1',
  ...
  describe('Shutdown', () => {
    it('should shutdown service cleanly', () => {
      ...
      expect((service as any).queue.size).toBe(0);
    });
  });
});
