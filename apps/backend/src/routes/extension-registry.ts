 ...
 */
router.get('/extension/:id', (req: Request, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
router.post('/unblock/:id', (req: Request, res: Response) => {
  try {
    const { id } = req.params;
 ...
 * Get blocklist
 */
router.get('/blocklist', (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/pin-version', (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/validate-version', (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/record-install/:id', (req: Request, res: Response) => {
  try {
    const { id } = req.params;
