 ...
 * }
 */
router.post("/e2ee/sessions/init", (req: Request, res: Response) => {
  try {
 ...
 * Get session status
 */
router.get("/e2ee/sessions/:sessionId", (req: Request, res: Response) => {
  try {
 ...
 * }
 */
router.post("/e2ee/encrypt", async (req: Request, res: Response) => {
  try {
 ...
 * }
 */
router.post("/e2ee/decrypt", async (req: Request, res: Response) => {
  try {
 ...
 * }
 */
router.post("/e2ee/verify-forward-secrecy", (req: Request, res: Response) => {
  try {
 ...
 */
router.delete("/e2ee/sessions/:sessionId", (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params
 ...
 */
router.post("/e2ee/backup-keys", async (req: Request, res: Response) => {
  try {
 ...
 * }
 */
router.post("/e2ee/restore-keys", async (req: Request, res: Response) => {
  try {
