...
export class EdgeOptimizationEngine {
     ...
     */
    updateEdgeNodeStatus(nodeId, isOnline, latency) {
     ...
     */
    createOptimizationProfile(nodeId, cachePolicy, compressionStrategy) {
     ...
     */
    getBandwidthOptimization(nodeId) {
...
//# sourceMappingURL=EdgeOptimizationEngine.js.map