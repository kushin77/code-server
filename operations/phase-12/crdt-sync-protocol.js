...
export class LWWCounter {
    constructor(key, value, replicaId, vectorClock) {
        this.id = uuidv4();
        this.key = key;
        this.value = value;
 ...
 */
export class ORSet {
    constructor(key, replicaId, vectorClock) {
        this.id = uuidv4();
        this.key = key;
...
export class CRDTSyncEngine extends EventEmitter {
    constructor(replicaId, regions, syncInterval = 1000, maxRetries = 3, retryBackoff = 100) {
        super();
        this.replicaId = replicaId;
