...
import { WorkspaceMetrics, PerformanceThreshold } from '../types.js';

describe('Workspace Performance Monitor Service', () => {
  let service: WorkspacePerformanceMonitor;
  ...
  describe('Initialization', () => {
    it('should initialize service', () => {
      ...
      expect((service as any).thresholds).toBeDefined();
    });
  ...
  describe('Threshold Management', () => {
    ...
    it('should update threshold', () => {
      ...
      const updated = service.updateThreshold(
        created.thresholdId!,
        { value: 200 },
        'admin',
        '192.168.1.1',
  ...
  describe('Shutdown', () => {
    it('should shutdown service cleanly', () => {
      ...
      expect((service as any).thresholds.size).toBe(0);
    });
  });
});
