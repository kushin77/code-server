...
describe('MentionSystemService', () => {
    ...
    describe('initialization', () => {
        it('should initialize with database schema', async () => {
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('CREATE TABLE IF NOT EXISTS mentions'));
        });
    });
    ...
    describe('getMentionsForUser', () => {
        ...
        it('should support pagination', async () => {
            ...
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('LIMIT $2 OFFSET $3'), expect.arrayContaining(['alice', 25, 50]));
        });
    });
...
//# sourceMappingURL=mention-system.test.js.map