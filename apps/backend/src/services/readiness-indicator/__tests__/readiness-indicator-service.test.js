...
describe('ReadinessIndicatorService', () => {
    ...
    describe('team readiness', () => {
        ...
        it('should calculate team readiness metrics', () => {
            ...
            const totalWithStatus = metrics.availableCount +
                metrics.busyCount +
                metrics.awayCount +
        ...
        it('should count team members by readiness level', () => {
            ...
            const total = metrics.availableCount +
                metrics.busyCount +
                metrics.awayCount +
                metrics.offlineCount +
                metrics.dndCount;
    ...
    describe('querying', () => {
        ...
        it('should filter by readiness level', () => {
            ...
            expect(result.statuses.every((s) => s.readinessLevel === ReadinessLevel.AVAILABLE)).toBe(true);
        });
...
//# sourceMappingURL=readiness-indicator-service.test.js.map