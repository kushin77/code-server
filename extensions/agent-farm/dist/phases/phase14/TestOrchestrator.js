...
const SecurityValidationTests_1 = require("./SecurityValidationTests");
const LoadTestRunner_1 = require("./LoadTestRunner");
const IntegrationTestSuite_1 = require("./IntegrationTestSuite");
/**
...
class TestOrchestrator {
    ...
    static async runComprehensiveTests() {
        ...
        const securityValidation = SecurityValidationTests_1.SecurityValidationTests.runAllTests();
        // Step 2: Integration Tests
        console.log('Running Integration Tests...');
        const integrationTests = IntegrationTestSuite_1.IntegrationTestSuite.runAllIntegrationTests();
        // Step 3: Performance/Load Tests
        console.log('Running Performance/Load Tests...');
        const performanceTests = LoadTestRunner_1.IntegrationLoadTest.runAllIntegrationTests();
        // Step 4: Validate SLOs
        console.log('Validating SLOs...');
        const sloValidation = this.validateSLOs(performanceTests);
        // Step 5: Generate summary
        const totalDuration = (Date.now() - startTime) / 1000;
        const summary = this.generateTestSummary(securityValidation, integrationTests, performanceTests, sloValidation);
        return {
            timestamp: new Date(),
            totalDuration,
            securityValidation,
     ...
     */
    static generateTestSummary(security, integration, performance, sloValidation) {
