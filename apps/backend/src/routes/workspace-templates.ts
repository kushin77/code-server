...
router.get('/search', (req: Request, res: Response) => {
  try {
    ...
    const templates = service.searchTemplates(q as string);
    return res.json({ success: true, templates, count: templates.length });
  } catch (error) {
 ...
 */
router.post('/:templateId/add-extension', (req: Request, res: Response) => {
  try {
 ...
 */
router.patch('/:templateId/settings', (req: Request, res: Response) => {
  try {
    const { templateId } = req.params;
 ...
 */
router.post('/:templateId/devcontainer', (req: Request, res: Response) => {
  try {
    const { templateId } = req.params;
 ...
 */
router.post('/:templateId/environment-schema', (req: Request, res: Response) => {
  try {
    const { templateId } = req.params;
 ...
 */
router.post('/:templateId/git', (req: Request, res: Response) => {
  try {
    const { templateId } = req.params;
 ...
 * Add tag to template
 */
router.post('/:templateId/tag', (req: Request, res: Response) => {
  try {
    const { templateId } = req.params;
    const { tag } = req.body;
 ...
 */
router.delete('/:templateId/tag/:tag', (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/:workspaceId/progress', (req: Request, res: Response) => {
  try {
 ...
 * Update template
 */
router.patch('/:templateId', (req: Request, res: Response) => {
  try {
    const { templateId } = req.params;
 ...
 * Clone template
 */
router.post('/:templateId/clone', (req: Request, res: Response) => {
  try {
    const { templateId } = req.params;
 ...
 */
router.get('/:templateId/export', (req: Request, res: Response) => {
  try {
    const { templateId } = req.params;
