...
describe('Change Stream Service', () => {
    ...
    describe('Subscriptions', () => {
        ...
        it('should update subscription', () => {
            ...
            const result = service.updateSubscription(created.subscriptionId, { status: 'paused' }, 'user1', '192.168.1.1', 'Mozilla');
            expect(result.success).toBe(true);
        });
    ...
    describe('Conflict Detection', () => {
        ...
        it('should resolve conflict', () => {
            ...
            if (conflicts.conflicts && conflicts.conflicts.length > 0) {
                const result = service.resolveConflict(conflicts.conflicts[0].conflictId, 'accept', 'user1', '192.168.1.1', 'Mozilla');
                expect(result.success).toBe(true);
            }
        });
    });
    ...
    describe('Change Application', () => {
        ...
        it('should batch apply changes', () => {
            ...
            const result = service.batchApplyChanges([recorded1.changeId], 'user1', '192.168.1.1', 'Mozilla');
            expect(result.success).toBe(true);
    ...
    describe('Change Revert', () => {
        ...
        it('should rollback changes', () => {
            ...
            const result = service.rollbackChanges([recorded.changeId], 'user1', '192.168.1.1', 'Mozilla');
            expect(result.success).toBe(true);
    ...
    describe('Shutdown', () => {
        it('should shutdown service cleanly', () => {
            service.shutdown();
            expect(service.changes.size).toBe(0);
            expect(service.subscriptions.size).toBe(0);
        });
    });
});
//# sourceMappingURL=change-stream-service.test.js.map