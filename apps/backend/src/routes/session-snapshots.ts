...
router.post("/", (req: Request, res: Response) => {
  try {
    ...
    const workspaceId = (req.user as any)?.workspaceId || "default"
 ...
 * }
 */
router.post("/:snapshotId/restore", (req: Request, res: Response) => {
  try {
    const { snapshotId } = req.params
 ...
 * }
 */
router.post("/:snapshotId/tag", (req: Request, res: Response) => {
  try {
    const { snapshotId } = req.params
    const { tags } = req.body
 ...
 */
router.get("/:sessionId/snapshots/stats", (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params
