...
export function initializeWorkspaceTemplateRoutes(service) {
    const router = Router();
    router.get('/api/workspace-templates/snapshot', async (_req, res) => {
        try {
    ...
    router.get('/api/workspace-templates/:templateId', async (req, res) => {
        try {
    ...
    router.get('/api/workspace-templates/:templateId/devcontainer', async (req, res) => {
        try {
