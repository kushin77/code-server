...
import type { CommunicationContext, ReadinessSignal, CollaborationPattern } from '../types';
...
describe('CommunicationOptimizationEngine', () => {
  ...
  describe('Communication Recommendations', () => {
    it('should recommend async communication for low urgency', async () => {
      ...
      expect([CommunicationMode.ASYNC_COMMENT, CommunicationMode.SUMMARY_DIGEST, CommunicationMode.DEFERRED]).toContain(
