...
describe('Role Management API Integration', () => {
    ...
    describe('Error Handling', () => {
        it('should return 500 on database error', async () => {
            mockRoleManager.assignRoles.mockRejectedValue(new Error('Database connection failed'));
            const response = {
                status: 500,
                json: {
        ...
        it('should return 500 on cache error', async () => {
            mockRoleManager.getUserRoles.mockRejectedValue(new Error('Redis unavailable'));
            const response = {
                status: 500,
                json: {
...
//# sourceMappingURL=roles.integration.test.js.map