...
export class CRDTCompactionService extends EventEmitter {
     ...
     */
    createSnapshot(docId, operations, currentContent) {
        const snapshot = {
            docId,
     ...
     */
    compactDocument(docId, allOperations, currentContent) {
     ...
     */
    shouldCompact(operations, lastCompactionTime) {
        ...
        return (opsCount > this.compactionThresholds.operationCount ||
     ...
     */
    removeOldSnapshots(olderThanHours) {
...
CRDTCompactionService.instances = new Map();
