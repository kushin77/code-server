...
export function initializeGuestSessionRoutes(service) {
    const router = Router();
    // Create guest session
    router.post('/api/guest/sessions', async (req, res) => {
        try {
            ...
            const session = await service.createGuestSession(userId, scopedPath, ttlMinutes, accessLevel || 'read');
    ...
    // Get guest session
    router.get('/api/guest/sessions/:guestToken', async (req, res) => {
        try {
    ...
    // Validate access
    router.post('/api/guest/validate', async (req, res) => {
        try {
    ...
    // Track activity
    router.post('/api/guest/activity', async (req, res) => {
        try {
    ...
    // List user sessions
    router.get('/api/guest/user/:userId/sessions', async (req, res) => {
        try {
    ...
    // Revoke session
    router.post('/api/guest/sessions/:guestSessionId/revoke', async (req, res) => {
        try {
    ...
    router.get('/api/guest/sessions/:guestSessionId/activity', async (req, res) => {
        try {
            const { guestSessionId } = req.params;
    ...
    // Get session stats
    router.get('/api/guest/user/:userId/stats', async (req, res) => {
        try {
            const { userId } = req.params;
    ...
    router.post('/api/guest/cleanup', async (req, res) => {
        try {
...
//# sourceMappingURL=guest-sessions.js.map