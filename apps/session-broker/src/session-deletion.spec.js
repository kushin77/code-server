...
import { buildSessionDeletionRecord, finalizeDeletionRecord, holdDeletionRecord, isDeletionHoldActive, isDeletionQuarantineExpired, releaseDeletionHold, } from './session-deletion.js';
describe('session deletion quarantine helpers', () => {
    ...
    it('detects quarantine expiry from the ttl deadline', () => {
        ...
        expect(isDeletionQuarantineExpired(expired, Date.now() + 10000)).toBe(true);
    });
});
//# sourceMappingURL=session-deletion.spec.js.map