...
## Quick Reference Guides (CONSOLIDATED MEMORY)

**Canonical 450+ line guides** for immediate reference:

1. **[Deployment Operations Guide](../memories/repo/deployment-operations-complete-guide.md)** — ⭐ Start here
   - Terraform SSH deployment (critical: don't deploy locally)
   - Health check verification
   - Deploy/rollback procedures
   - Troubleshooting checklist
   - DR recovery playbook

2. **[Infrastructure-as-Code Reference](../memories/repo/infrastructure-as-code-reference.md)** — Architecture foundation
   - Core ADRs (on-prem, immutable, modular)
   - Terraform module structure & dependencies
   - DNS architecture & VRRP VIP setup
   - State management & immutability patterns
   - Configuration consolidation status

3. **[Memory Index](../memories/repo/README.md)** — Full knowledge navigation
   - All canonical files indexed
   - GitHub Issues as SSOT
   - Consolidation timeline & impact
