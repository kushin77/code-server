...
import NetworkMigrationRecoveryService from '../migration-recovery-service';
describe('NetworkMigrationRecoveryService', () => {
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle multiple network type transitions', () => {
            const types = ['wifi', '4g', 'ethernet', 'wifi', '4g'];
...
//# sourceMappingURL=migration-recovery-service.test.js.map