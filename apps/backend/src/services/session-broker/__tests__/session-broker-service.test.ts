...
import { BrokerInstance, SessionRoutingContext } from '../types'
...
describe('SessionBrokerService', () => {
  ...
  describe('Initialization', () => {
    ...
    it('should throw if getInstance called without config before init', () => {
      SessionBrokerService['instances'].clear()
      expect(() => SessionBrokerService.getInstance()).toThrow(
        'SessionBrokerService not initialized'
      )
    })
  })
  ...
  describe('Session Routing', () => {
    ...
    it('should route different sessions to different instances', () => {
      const contexts: SessionRoutingContext[] = [
  ...
  describe('Instance Management', () => {
    it('should add new instance', () => {
      const newInstance: BrokerInstance = {
        id: 'instance-4',
        host: 'localhost',
        port: 8004,
        status: 'healthy',
    ...
    it('should not add duplicate instance', () => {
      const duplicate: BrokerInstance = {
        id: 'instance-1',
        host: 'localhost',
        port: 9001,
        status: 'healthy',
...
describe('ConsistentHashRing', () => {
  ...
  describe('Consistent Hashing', () => {
    ...
    it('should handle node removal with minimal remapping', () => {
      ...
      const beforeRemoval = new Map<string, string>()
      ...
      const afterRemoval = new Map<string, string>()
      let remappedCount = 0
