...
import { WorkspaceContext, WorkspaceSwitchRequest } from '../types.js';

describe('HotSwitchService', () => {
  let service: HotSwitchService;
  ...
  it('should calculate average switch time', async () => {
    const request1: WorkspaceSwitchRequest = {
    ...
    const request2: WorkspaceSwitchRequest = {
