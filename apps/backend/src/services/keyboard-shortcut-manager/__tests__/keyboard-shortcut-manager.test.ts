...
describe('KeyboardShortcutManagerService', () => {
  ...
  it('should create a profile', async () => {
    ...
    const profileId = await service.createProfile(
      'VS Code',
  ...
  it('should set personal overrides', async () => {
    ...
    expect(mockClient.query).toHaveBeenCalledWith(
      expect.stringContaining('INSERT INTO personal_shortcut_overrides'),
      expect.any(Array)
    );
  });
  ...
  it('should track shortcut usage', async () => {
    ...
    expect(mockClient.query).toHaveBeenCalledWith(
      expect.stringContaining('INSERT INTO shortcut_usage_tracking'),
      expect.any(Array)
    );
  });
  ...
  it('should sync profile to team', async () => {
    ...
    expect(mockClient.query).toHaveBeenCalledWith(
      expect.stringContaining('INSERT INTO shortcut_team_sync'),
      expect.any(Array)
    );
  });
  ...
  it('should delete profile', async () => {
    ...
    expect(mockClient.query).toHaveBeenCalledWith(
      expect.stringContaining('DELETE FROM shortcut_profiles'),
      expect.any(Array)
    );
  });
  ...
  it('should update profile', async () => {
    ...
    expect(mockClient.query).toHaveBeenCalledWith(
      expect.stringContaining('UPDATE shortcut_profiles'),
      expect.any(Array)
    );
  });
