 ...
 */
export function getWorkloadIdentityClient(config) {
    if (!globalClient) {
 ...
 */
export async function requestWorkloadToken() {
...
//# sourceMappingURL=workload-identity-token-client.js.map