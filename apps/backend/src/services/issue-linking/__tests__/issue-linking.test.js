...
describe('IssueLinkingService', () => {
    ...
    describe('initialization', () => {
        it('should initialize with database schema', async () => {
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('CREATE TABLE IF NOT EXISTS issue_tickets'));
        });
    ...
    describe('searchTickets', () => {
        ...
        it('should cache search results', async () => {
            ...
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('issue_search_cache'), expect.any(Array));
        });
    });
    describe('saveTicket', () => {
        it('should save a ticket', async () => {
            ...
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO issue_tickets'), expect.any(Array));
        });
    ...
    describe('linkIssue', () => {
        it('should link a ticket to GitHub issue', async () => {
            ...
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO linked_issues'), expect.any(Array));
        });
    ...
    describe('saveIssueContext', () => {
        it('should save issue context', async () => {
            ...
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO issue_context'), expect.any(Array));
        });
    ...
    describe('saveBranchName', () => {
        it('should save branch name', async () => {
            ...
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO branch_names'), expect.any(Array));
        });
        it('should save actual branch name if provided', async () => {
            ...
            expect(mockClient.query).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO branch_names'), expect.arrayContaining(['feature/eng-123-user-auth']));
        });
    });
...
//# sourceMappingURL=issue-linking.test.js.map