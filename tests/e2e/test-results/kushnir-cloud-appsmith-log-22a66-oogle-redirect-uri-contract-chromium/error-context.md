...
- Name: kushnir-cloud-appsmith-login.spec.ts >> kushnir.cloud Appsmith login path >> portal oauth start resolves to expected google redirect_uri contract
- Location: specs\kushnir-cloud-appsmith-login.spec.ts:138:7

# Error details

```
Error: apiRequestContext.get: write EPROTO 20740000:error:0A000438:SSL routines:ssl3_read_bytes:tlsv1 alert internal error:openssl\ssl\record\rec_layer_s3.c:916:SSL alert number 80

Call log:
  - → GET https://kushnir.cloud/oauth2/start?rd=%2F
