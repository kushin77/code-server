...
describe("PR Preview Routes", () => {
    ...
    describe("Billing Response", () => {
        it("should format billing information", () => {
            ...
            expect((response.breakdown.computerCost +
                response.breakdown.databaseCost +
                response.breakdown.networkCost).toFixed(2)).toBe(response.totalCost.toFixed(2));
        });
...
//# sourceMappingURL=pr-preview.test.js.map