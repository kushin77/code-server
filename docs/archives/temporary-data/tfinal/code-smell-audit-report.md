...
- Timestamp (UTC): 2026-04-21T12:24:36Z
- Strict mode: 1
- Run ESLint checks: 1
...
## ESLint Strict Mode
- FAIL: apps/frontend eslint strict check
...
apps/frontend/src/types/repo-card.ts:11 - RepoCard
apps/frontend/src/types/repo-card.ts:38 - RepoCardError (used in module)
apps/frontend/src/types/repo-card.ts:51 - RepoCardAction
...
## Complexity Checks
- FAIL: apps/frontend has complexity violations > 40
