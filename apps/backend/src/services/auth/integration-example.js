...
import { JwtValidator, JwtTokenClient, jwtAuth, requireJwt, requireClaim, JwtRedisCache, } from './index.js';
 ...
 */
export function setupIncomingJwtValidation(app, validator) {
    // ─────────────────────────────────────────────────────────────────────
    ...
    app.get('/api/users/:userId', requireJwt(), async (req, res) => {
        const reqWithJwt = req;
    ...
    app.post('/api/admin/settings', requireClaim('groups', 'admin'), async (req, res) => {
 ...
 */
export function setupOutgoingJwtTokens(app, tokenClient) {
    // ─────────────────────────────────────────────────────────────────────
 ...
 */
export async function initializeJwtAuthStack(app, config) {
    // ─────────────────────────────────────────────────────────────────────
    // Create JWT services
    // ─────────────────────────────────────────────────────────────────────
    ...
    if (config.redisUrl) {
        ...
        await cache.storeServiceCredentials(config.clientId, config.clientId, config.clientSecret);
    }
    // ─────────────────────────────────────────────────────────────────────
...
function canAccess(caller, userId) {
