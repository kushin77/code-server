...
import { LockRequest, LockMode } from '../types.js';

describe('Distributed Lock Manager Service', () => {
  let service: DistributedLockManager;
  ...
  describe('Initialization', () => {
    it('should initialize service', () => {
      ...
      expect((service as any).locks).toBeDefined();
      expect((service as any).resourceLocks).toBeDefined();
    });
  ...
  describe('Shutdown', () => {
    it('should shutdown service cleanly', () => {
      ...
      expect((service as any).locks.size).toBe(0);
      expect((service as any).resourceLocks.size).toBe(0);
    });
  });
