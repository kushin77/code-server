...
PHASE_SCRIPTS=(
    ...
    "scripts/maintenance/apply-deduplication-fixes.sh"
    "scripts/ci/pre-deployment-validation.sh"
    "scripts/configure-rbac-secrets.sh"
    "scripts/ops/deploy-compose-updates.sh"
    "scripts/integration-test.sh"
    "scripts/ci/codebase-hygiene-audit.sh"
    "scripts/ops/autonomous-operations-orchestrator.sh"
    "scripts/configure-rbac-secrets.sh"
    "scripts/maintenance/apply-deduplication-fixes.sh"
    "scripts/ops/deployment-pipeline.sh"
    "scripts/dr/disaster-recovery-orchestrator.sh"
    "scripts/ci/pre-deployment-validation.sh"
    "scripts/ops/deploy-core-services.sh"
