...
describe('Activity Feed Service', () => {
  ...
  describe('Initialization', () => {
    it('should initialize service', () => {
      ...
      expect((service as any).activities).toBeDefined();
      expect((service as any).filters).toBeDefined();
    });
  ...
  describe('Shutdown', () => {
    it('should shutdown service cleanly', () => {
      ...
      expect((service as any).activities.size).toBe(0);
      expect((service as any).filters.size).toBe(0);
    });
  });
});
