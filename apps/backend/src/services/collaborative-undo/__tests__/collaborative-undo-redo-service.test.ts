...
describe('CollaborativeUndoRedoService', () => {
  let service: CollaborativeUndoRedoService;

  beforeEach(() => {
    (CollaborativeUndoRedoService as any).reset();
  ...
  describe('Undo', () => {
    it('should undo operation', () => {
      ...
      const result = service.undo(
        { userId: 'user-6', userEmail: 'user6@example.com' },
        'doc-6',
        '192.168.1.1',
        'Mozilla/5.0'
      );
    ...
    it('should not undo empty history', () => {
      const result = service.undo(
        { userId: 'user-8', userEmail: 'user8@example.com' },
        'non-existent',
        '192.168.1.1',
        'Mozilla/5.0'
      );
  ...
  describe('Redo', () => {
    it('should redo operation after undo', () => {
      ...
      const result = service.redo(
        { userId: 'user-11', userEmail: 'user11@example.com' },
        'doc-redo',
        '192.168.1.1',
        'Mozilla/5.0'
      );
