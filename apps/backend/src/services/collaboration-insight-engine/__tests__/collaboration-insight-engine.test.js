...
import { createCollaborationInsightEngine } from '../collaboration-insight-engine';
describe('CollaborationInsightEngine', () => {
    ...
    describe('Interaction Recording', () => {
        ...
        it('should handle multiple interaction types', async () => {
            const types = ['mentorship', 'collaboration', 'code_review', 'pairing', 'assistance'];
...
//# sourceMappingURL=collaboration-insight-engine.test.js.map