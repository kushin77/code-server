...
import {
  ...
  fetchWorkspaceTemplateCatalog,
  fetchWorkspaceTemplateDevcontainer,
  type WorkspaceTemplateCatalogSnapshot,
...
describe('workspaceTemplates helpers', () => {
  it('fetches the workspace template catalog', async () => {
    const catalogSnapshot: WorkspaceTemplateCatalogSnapshot = {
      templates: [
        {
  ...
  it('fetches a single workspace template by id', async () => {
    ...
    expect(mockFetch).toHaveBeenCalledWith(
      '/api/workspace-templates/collaboration-core',
      expect.any(Object)
    )
  })
  ...
  it('fetches devcontainer for a template', async () => {
    ...
    expect(mockFetch).toHaveBeenCalledWith(
      '/api/workspace-templates/collaboration-core/devcontainer',
      expect.any(Object)
    )
  })
})
