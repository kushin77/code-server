...
describe('SyncProtocol log compaction', () => {
    ...
    it('removes oldest operations when the log exceeds the size limit', () => {
        const protocol = new SyncProtocol({
            ...baseConfig,
            operationLogRetentionMs: 86400000,
