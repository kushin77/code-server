...
- Latest branch portal run `24610724917` also reaches `google-github-actions/auth@v2` and fails with the same invalid audience error after WIF provider normalization.
