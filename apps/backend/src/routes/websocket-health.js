 ...
 */
router.post('/websocket/register', (req, res) => {
    try {
        ...
        const metrics = healthService.registerConnection(connectionId, sessionId, userId);
        res.status(201).json({
            success: true,
            metrics,
        });
 ...
 */
router.post('/websocket/health-check', (req, res) => {
    try {
 ...
 */
router.post('/websocket/message-delivery', (req, res) => {
    try {
 ...
 */
router.post('/websocket/message-loss', (req, res) => {
    try {
 ...
 */
router.post('/websocket/close', (req, res) => {
    try {
 ...
 */
router.get('/websocket/health/:connectionId', (req, res) => {
    try {
 ...
 */
router.get('/websocket/metrics', (req, res) => {
    try {
 ...
 */
router.get('/websocket/session/:sessionId', (req, res) => {
    try {
 ...
 */
router.get('/websocket/prometheus', (req, res) => {
    try {
...
router.get('/websocket/health', (req, res) => {
    try {
        const metrics = healthService.getAggregatedMetrics();
        const status = {
            status: metrics.criticalIssueCount === 0 ? 'healthy' : 'degraded',
            ...
            metrics: {
                ...
                avgDeliverySuccessRate: metrics.avgDeliverySuccessRate.toFixed(2),
                criticalIssues: metrics.criticalIssueCount,
                warnings: metrics.warningIssueCount,
            },
        };
        const statusCode = metrics.criticalIssueCount === 0 ? 200 : 503;
